...
static void bench_rsa3072(FILE *csv, FILE *raw_csv, const char *only_op) {
...
static void bench_ecdsa_p256(FILE *csv, FILE *raw_csv, const char *only_op) {
...
int main(int argc, char *argv[]) {
    ...
    if (!only_algo || strcmp(only_algo, "RSA-3072") == 0)
        bench_rsa3072(csv, raw_csv, only_op);
    if (!only_algo || strcmp(only_algo, "ECDSA-P256") == 0)
        bench_ecdsa_p256(csv, raw_csv, only_op);
